...
// $tengv = $this->nhatkymodel->tengvql(572, 32);
// // $arrKetQua = $this->nhatkymodel->laydulieu($idphong,30);
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h2 class="modal-title" id="exampleModalLongTitle" style="font-size: 20px;float: left;">
                <p>Thêm mới</p>
              </h2>
            ...
            <form class="form-horizontal form-label-left" autocomplete="off" action="<?= nguoidung_url('nhatkycontroller/themnhatky') ?>" method="POST" onsubmit="return validate()">
      ...
      <div class="modal fade" id="modalthemcu" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <form class="form-horizontal form-label-left" autocomplete="off" action="<?= nguoidung_url('nhatkycontroller/themnhatky_cu') ?>" method="POST">
              <div class="modal-body">
      ...
      <div class="modal fade" id="modalthembaotri" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h2 class="modal-title" id="exampleModalLongTitle" style="font-size: 20px;float: left;">
                <p>Thêm nhật ký bảo trì</p>
              </h2>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form class="form-horizontal form-label-left" autocomplete="off" action="<?= nguoidung_url('nhatkytinhtrangtbcontroller/themnhatky') ?>" method="POST">
              <div class="modal-body">
      ...
      <div class="modal fade" id="modalsua" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <form class="form-horizontal form-label-left" action="<?= nguoidung_url('nhatkycontroller/capnhatnhatky') ?>" method="POST" onsubmit="return validate_update()">
              <div class="modal-body">
      ...
      <div class="modal fade" id="modalcapnhatbaotri" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h2 class="modal-title" id="exampleModalLongTitle" style="font-size: 20px;float: left;">
                <p>Chỉnh sửa nhật ký bảo trì</p>
              </h2>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form class="form-horizontal form-label-left" autocomplete="off" action="<?= nguoidung_url('nhatkytinhtrangtbcontroller/capnhat') ?>" method="POST">
              <div class="modal-body">
      ...
      <div class="modal fade" id="modalin" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <form class="form-horizontal form-label-left" action="<?= nguoidung_url('nhatkycontroller/xuatsonhatky') ?>" method="POST">
              <div class="modal-body">
                <div class="form-group">
                  <label>HỌC KỲ</label>
      ...
      <div class="modal fade" id="modalin_baotri" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h2 class="modal-title" id="exampleModalLongTitle" style="font-size: 20px;float: left;">
                <p>In sổ bảo trì/sửa chữa</p>
              </h2>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form class="form-horizontal form-label-left" action="<?= nguoidung_url('nhatkytinhtrangtbcontroller/xuatsonhatky') ?>" method="POST">
              <div class="modal-body">
                <div class="form-group">
                  <label>HỌC KỲ</label>
                  <select class="form-control" name="hockyin" required="required" class="form-control">
          ...
          $.ajax({
            ...
            success: function(data) {
              ...
              for (let i = 0; i < arrResult.length; i++) {
                arrPhong.push({
                  label: arrResult[i].maphong + " (" + arrResult[i].tenphong + ")",
