          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <button class="btn btn-primary" data-toggle="modal" data-target="#modalthemexcel">Thêm kho bằng excel</button>
                    <button class="btn btn-primary" data-toggle="modal" data-target="#modalthem">Thêm kho</button>
        ...
        <div class="modal-body">
          <div class="form-group">
                ...
                <div class="col-md-9 col-sm-6 col-xs-12">
                    ...
                    <small class="form-text text-muted"><a href='href="<?= public_url('bieumau/BM_KHO.xls') ?>"'>Biểu mẫu thêm</a></small>
                </div>
          </div>
...
<div class="modal fade" id="modalthem" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form class="form-horizontal form-label-left" method="post" action="<?php echo donvi_url('phong_khocontroller/them1phongkho') ?>">
        <div class="modal-body">
          <div class="form-group">
            <label class="control-label col-md-2 col-sm-3 col-xs-12" for="first-name">Mã phòng
             </label>
            <div class="col-md-9 col-sm-6 col-xs-12">
                <input type="text" name="maphong" required class="form-control col-md-7 col-xs-12"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-6 col-xs-12">
                <input type="text" name="khu" required class="form-control col-md-7 col-xs-12"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-6 col-xs-12">
                <input type="text" name="lau" required class="form-control col-md-7 col-xs-12"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-6 col-xs-12">
                <input type="text" name="sophong" required class="form-control col-md-7 col-xs-12"/>
            </div>
          </div>
